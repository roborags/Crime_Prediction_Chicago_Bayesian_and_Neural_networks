...
Crime_MD_Norm = [[[0 for z in range(13)] for y in range(13)] for x in range(26)]
#Crime_MD_Prob = [[0 for y in range(13)] for x in range(26)]
Homicide_Final_Prob = [[0 for y in range(13)] for x in range(26)]
Crime_Class_Count = [[[0 for z in range(11)] for y in range(13)] for x in range(26)]
Crime_Class_Prob = [[[0 for z in range(11)] for y in range(13)] for x in range(26)]
...
Crime_MD_Mean = [[0 for y in range(13)] for x in range(26)] 
Crime_MD_SD = [[0 for y in range(13)] for x in range(26)] 
...
def Probabilty_Homicide_district(District):
	...
	for district in range (1,26): 	# for every district		
		for month in range (1,13):
			for year in range (1,13):
				...
				Crime_MD_Mean[district][month] += Crime_Year_Count[district][month][year]
				#else:
					#District_Month_Count -= 1
			Crime_MD_Mean[district][month] /= 12
	...
	#for district in range (1,26): 	# for every district		
		#for month in range (1,13):
			for year in range (1,13):
			#if(Crime_MD_Count[district][month] != 0):
				Crime_MD_SD[district][month] += (Crime_Year_Count[district][month][year]  - Crime_MD_Mean[district][month])**2
			
			Crime_MD_SD[district][month] /= 12
	...
	#for district in range (1,26): 	# for every district
		#for month in range (1,13):
			for year in range (1,13):
				if Crime_MD_Mean[district][month] != 0:
					Crime_MD_Norm[district][month][year] = MapNormalVal((Crime_Year_Count[district][month][year] - Crime_MD_Mean[district][month]) / math.sqrt(Crime_MD_SD[district][month]))	
					Crime_Class_Count[district][month][Crime_MD_Norm[district][month][year]] +=1
				else:
					Crime_MD_Norm[district][month][year] = 0
		
			for class_num in range (1,11):
				if Crime_Class_Count[district][month][class_num] == 0:
					Crime_Class_Count[district][month][class_num] = 1
				Crime_Class_Prob[district][month][class_num] = Crime_Class_Count[district][month][class_num]/12
	...
	for class_num in range (1,11):
		for district in range (1,26): 	# for every district	
			...
			for month in range (1,13):
				for year in range (1,13):
					if Crime_MD_Norm[district][month][year] == class_num:
						count += 1
			Crime_District_Cond_Prob[district][class_num] = count/Crime_Class_Count[district][month][class_num]
		...
		for month in range (1,13):
			...
			for district in range (1,26): 	# for every district	
				for year in range (1,13):
					if Crime_MD_Norm[district][month][year] == class_num:
						count += 1
			Crime_Month_Cond_Prob[month][class_num] = count/Crime_Class_Count[district][month][class_num]
			
	for district in range (1,26): 	# for every district
		for month in range (1,13):
			greatest_prob = 0
			for class_num in range (1,11):
				Crime_Final_Prob[district][month][class_num] = Crime_District_Cond_Prob[district][class_num] * Crime_Month_Cond_Prob[month][class_num] * Crime_Class_Prob[district][month][class_num]
	...
	for class_num in range (1,11):		
		...
		for district in range (1,26): 	# for every district
			for month in range (1,13):		
				Crime_Class_Pred[district][month][class_num] = round(((SD_mult_val*math.sqrt(Crime_MD_SD[district][month])) + Crime_MD_Mean[district][month]))
